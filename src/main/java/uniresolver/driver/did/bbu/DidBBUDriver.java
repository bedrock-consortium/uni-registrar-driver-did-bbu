package uniresolver.driver.did.bbu;
...
public class DidBBUDriver implements Driver {

	private static Logger log = LoggerFactory.getLogger(DidBBUDriver.class);

	public static final Pattern DID_BBU_PATTERN = Pattern.compile("^did:bbu:(?:(\\w[-\\w]*(?::\\w[-\\w]*)*):)?([1-9A-HJ-NP-Za-km-z]{21,22})$");
	...
	public DidBBUDriver(Map<String, Object> properties) {
	...
	private static Map<String, Object> getPropertiesFromEnvironment() {
		...
		try {
			...
			String env_libIndyPath = System.getenv("uniresolver_driver_did_bbu_libIndyPath");
			String env_poolConfigs = System.getenv("uniresolver_driver_did_bbu_poolConfigs");
			String env_poolVersions = System.getenv("uniresolver_driver_did_bbu_poolVersions");
			String env_walletName = System.getenv("uniresolver_driver_did_bbu_walletName");
	...
	public ResolveResult resolve(String identifier) throws ResolutionException {
		...
		Matcher matcher = DID_BBU_PATTERN.matcher(identifier);
	...
	private static String expandVerkey(String did, String verkey) {
		...
		if (verkey == null || ! did.startsWith("did:bbu:") || ! verkey.startsWith("~")) return verkey;
